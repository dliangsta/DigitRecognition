...
public class Node
{
   ...
   /**
    * Calculate the output of a ReLU node. You can assume that outputs of the parent nodes have already been calculated You can get this value by using getOutput()
    * 
    * @param train:
    *           the training set
    */
