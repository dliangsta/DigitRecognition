...
public class NeuralNetworkBuilder 
{
	...
	public static void main(String[] args)
	{
		...
		if (args.length < 5) 
		{
			System.out.println("usage: java NeuralNetworkBuilder <noHiddenNode> " +
		...
		NeuralNetwork nn=new NeuralNetwork(trainingSet,Integer.parseInt(args[0]),Double.parseDouble(args[1]),Integer.parseInt(args[2]), 
