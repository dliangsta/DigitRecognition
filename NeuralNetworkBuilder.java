...
public class NeuralNetworkBuilder 
{
	...
	public static void main(String[] args)
	{
		...
		if (args.length < 5) 
		{
			System.out.println("usage: java NeuralNetworkBuilder <noHiddenNode> learningRate> <maxEpoch> <trainFile> <testFile>");
			System.exit(-1);
		}
...
s		if(learningRate > 1 || learningRate <= 0)
		{
			System.out.println("Incorrect value for learning rate\n");
			System.exit(-1);
		}

		NeuralNetwork n = new NeuralNetwork(trainingSet, Integer.parseInt(args[0]), Double.parseDouble(args[1]), Integer.parseInt(args[2]), hiddenWeights,outputWeights);
		nn.train();
